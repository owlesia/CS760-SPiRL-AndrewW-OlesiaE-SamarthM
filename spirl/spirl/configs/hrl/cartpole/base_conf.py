...
from spirl.rl.envs.cartpole import CartPoleEnv
...
from spirl.configs.default_data_configs.cartpole import data_spec

current_dir = os.path.dirname(os.path.realpath(__file__))

notes = 'hierarchical RL on the cartpole env'
...
ll_agent_config.update(AttrDict(
    ...
    model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                  "skill_prior_learning/cartpole/hierarchical"),
))
